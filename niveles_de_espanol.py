...
test_music = pygame.mixer.Sound(
    resource_path("demon_slayer_cats_instrumental.mp3"))
...
def open_a_lesson(
        lesson1, lesson2=False, lesson3=False, lesson4=False, lesson5=False):
    global lesson_page, lesson_page1, lesson_page2, lesson_page3, lesson_page4
    global lesson_page5
    click.play()
...
def next_page_of_lesson():
    ...
    global lesson_page5
    click.play()
    if lesson_page == 1 and lesson_page2 is not False:
        lesson_page = 2
        bottom_comments_label.setText(lesson_page2)

    elif lesson_page == 2 and lesson_page3 is not False:
        lesson_page = 3
        bottom_comments_label.setText(lesson_page3)

    elif lesson_page == 3 and lesson_page4 is not False:
        lesson_page = 4
        bottom_comments_label.setText(lesson_page4)

    elif lesson_page == 4 and lesson_page5 is not False:
        lesson_page = 5
...
def answer_verification(button_clicked=None):
    ...
    if exercice < 8:
        if right_ans_button == button_clicked:
            ...
            bottom_comments_label.setText(
                f"La repuesta es {true_answer_variable}.")
    ...
    if wrong_answer:
        ...
        if random_text == 1:
            ...
            top_comments_label.setText(
                "¡Ups! Parece que eso no fue lo correcto.")
        ...
        if random_answer == 1:
            top_comments_label.setText(
                "Tienes una oportunidad entre mil \n"
    ...
    if test_finished:
        ...
        if not test:
            ...
            if test_questions == 10:
                ...
                ok_button.show()
                test_finished = True
                top_of_screen.setText(
                    "La nota de esta evaluación es " + str(test_note))
...
def four_answers_mode(question, ans1, ans2, ans3, ans4):
    ...
    bottom_comments_label.setText(
        "     Tienes que encontrar la forma correcta de \n conjugación y "
...
def typing_answer_mode(question, true_ans):
    ...
    bottom_comments_label.setText(
        "Si no tienes un taclado español:  ú  á  ó  é  í  ñ")
    bottom_comments_label.show()
...
def two_answers_mode(question, right_answer):
    ...
    top_comments_label.setText(
        "Tienes que encuentre el verbo correcto \n     y presione uno de estos"
        " botones.")
    top_comments_label.show()
...
def exercice1():
    ...
    if random_question == 1:
        ...
        if random_question == 1:
            four_answers_mode(
                "Vivir con yo.", "vives", "vivir", "vivimos", "vivo")

        elif random_question == 2:
            four_answers_mode(
                "Hablar con yo.", "hablas", "hablar", "hablamos", "hablo")

        elif random_question == 3:
            four_answers_mode(
                "Comer con yo.", "comas", "comer", "comemos", "como")
        ...
        if random_question == 1:
            four_answers_mode(
                "Vivir con tú.", "vivo", "vivir", "vivimos", "vives")

        elif random_question == 2:
            four_answers_mode(
                "Hablar con tú.", "hablo", "hablar", "hablamos", "hablas")

        elif random_question == 3:
            four_answers_mode(
                "Comer con tú.", "como", "comer", "comemos", "comes")
        ...
        if random_question == 1:
            four_answers_mode(
                "Vivir con él.", "vivo", "vivi", "vivimos", "vive")

        elif random_question == 2:
            four_answers_mode(
                "Hablar con él.", "hablo", "hablar", "hablamos", "habla")

        elif random_question == 3:
            four_answers_mode(
                "Comer con él.", "como", "comer", "comemos", "come")

        elif random_question == 4:
            four_answers_mode(
                "Vivir con ella.", "vivo", "vivi", "vivimos", "vive")

        elif random_question == 5:
            four_answers_mode(
                "Hablar con ella.", "hablo", "hablar", "hablamos", "habla")

        elif random_question == 6:
            four_answers_mode(
                "Comer con ella.", "como", "comer", "comemos", "come")

        elif random_question == 7:
            four_answers_mode(
                "Vivir con Juan.", "vivo", "vivi", "vivimos", "vive")

        elif random_question == 8:
            four_answers_mode(
                "Hablar con Juan.", "hablo", "hablar", "hablamos", "habla")

        elif random_question == 9:
            four_answers_mode(
                "Comer con Juan.", "como", "comer", "comemos", "come")

        elif random_question == 10:
            four_answers_mode(
                "Vivir con Carla.", "vivo", "vivi", "vivimos", "vive")

        elif random_question == 11:
            four_answers_mode(
                "Hablar con Carla.", "hablo", "hablar", "hablamos", "habla")

        elif random_question == 12:
            four_answers_mode(
                "Comer con Carla.", "como", "comer", "comemos", "come")

        elif random_question == 13:
            four_answers_mode(
                "Vivir con usted.", "vivo", "vivi", "vivimos", "vive")

        elif random_question == 14:
            four_answers_mode(
                "Hablar con usted.", "hablo", "hablar", "hablamos", "habla")

        elif random_question == 15:
            four_answers_mode(
                "Comer con usted.", "como", "comer", "comemos", "come")
        ...
        if random_question == 1:
            four_answers_mode(
                "Vivir con nosotros.", "vivo", "vivir", "vives", "vivimos")

        elif random_question == 2:
            four_answers_mode(
                "Hablar con nosotros.", "hablo", "hablar",
                "hablas", "hablamos")

        elif random_question == 3:
            four_answers_mode(
                "Comer con nosotros.", "como", "comer", "comes", "comemos")

        elif random_question == 4:
            four_answers_mode(
                "Vivir con nosotras.", "vivo", "vivir", "vives", "vivimos")

        elif random_question == 5:
            four_answers_mode(
                "Hablar con nosotras.", "hablo", "hablar",
                "hablas", "hablamos")

        else:
            four_answers_mode(
                "Comer con nosotras.", "como", "comer", "comes", "comemos")
        ...
        if random_question == 1:
            four_answers_mode(
                "Vivir con vosotros.", "vivo", "vivir", "vives", "vivís")

        elif random_question == 2:
            four_answers_mode(
                "Hablar con vosotros.", "hablo", "hablar", "hablas", "habláis")

        elif random_question == 3:
            four_answers_mode(
                "Comer con vosotros.", "como", "comer", "comes", "coméis")

        elif random_question == 1:
            four_answers_mode(
                "Vivir con vosotras.", "vivo", "vivir", "vives", "vivís")

        elif random_question == 2:
            four_answers_mode(
                "Hablar con vosotras.", "hablo", "hablar", "hablas", "habláis")

        else:
            four_answers_mode(
                "Comer con vosotras.", "como", "comer", "comes", "coméis")
        ...
        if random_question == 1:
            four_answers_mode(
                "Vivir con ellos.", "vivo", "vivimos", "vives", "viven")

        elif random_question == 2:
            four_answers_mode(
                "Hablar con ellos.", "hablo", "hablamos", "hablas", "hablan")

        elif random_question == 3:
            four_answers_mode(
                "Comer con ellos.", "como", "comemos", "comes", "comen")

        elif random_question == 4:
            four_answers_mode(
                "Vivir con ellas.", "vivo", "vivimos", "vives", "viven")

        elif random_question == 5:
            four_answers_mode(
                "Hablar con ellas.", "hablo", "hablamos", "hablas", "hablan")

        elif random_question == 6:
            four_answers_mode(
                "Comer con ellas.", "como", "comemos", "comes", "comen")

        elif random_question == 7:
            four_answers_mode(
                "Vivir con Carla y Juan.", "vivo", "vivimos", "vives", "viven")

        elif random_question == 8:
            four_answers_mode(
                "Hablar con Carla y Juan.", "hablo",
                "hablamos", "hablas", "hablan")

        elif random_question == 9:
            four_answers_mode(
                "Comer con Carla y Juan.", "como", "comemos", "comes", "comen")

        elif random_question == 10:
            four_answers_mode(
                "Vivir con ustedes.", "vivo", "vivimos", "vives", "viven")

        elif random_question == 11:
            four_answers_mode(
                "Hablar con ustedes.", "hablo", "hablamos", "hablas", "hablan")

        elif random_question == 12:
            four_answers_mode(
                "Comer con ustedes.", "como", "comemos", "comes", "comen")
...
def exercice2():
    ...
    if random_question == 1:
        ...
        if random_question == 1:
            four_answers_mode(
                "Tener con yo.", "tiene", "tener", "tenemos", "tengo")

        elif random_question == 2:
            four_answers_mode(
                "Ser con yo.", "es", "ser", "somos", "soy")

        elif random_question == 3:
            four_answers_mode(
                "Ir con yo.", "va", "ir", "vamos", "voy")
        ...
        if random_question == 1:
            four_answers_mode(
                "Tener con él.", "tengo", "tener", "tenemos", "tiene")

        elif random_question == 2:
            four_answers_mode(
                "Ser con él.", "soy", "ser", "somos", "es")

        elif random_question == 3:
            four_answers_mode(
                "Ir con él.", "voy", "ir", "vamos", "va")

        elif random_question == 4:
            four_answers_mode(
                "Tener con ella.", "tengo", "tener", "tenemos", "tiene")

        elif random_question == 5:
            four_answers_mode(
                "Ser con ella.", "soy", "ser", "somos", "es")

        elif random_question == 6:
            four_answers_mode(
                "Ir con ella.", "voy", "ir", "vamos", "va")

        elif random_question == 7:
            four_answers_mode(
                "Tener con Juan.", "tengo", "tener", "tenemos", "tiene")

        elif random_question == 8:
            four_answers_mode(
                "Ser con Juan.", "soy", "ser", "somos", "es")

        elif random_question == 9:
            four_answers_mode(
                "Ir con Juan.", "voy", "ir", "vamos", "va")

        elif random_question == 10:
            four_answers_mode(
                "Tener con Carla.", "tengo", "tener", "tenemos", "tiene")

        elif random_question == 11:
            four_answers_mode(
                "Ser con Carla.", "soy", "ser", "somos", "es")

        elif random_question == 12:
            four_answers_mode(
                "Ir con Carla.", "voy", "ir", "vamos", "va")

        elif random_question == 13:
            four_answers_mode(
                "Tener con usted.", "tengo", "tener", "tenemos", "tiene")

        elif random_question == 14:
            four_answers_mode(
                "Ser con usted.", "soy", "ser", "somos", "es")

        elif random_question == 15:
            four_answers_mode(
                "Ir con usted.", "voy", "ir", "vamos", "va")
        ...
        if random_question == 1:
            four_answers_mode(
                "Tener con nosotros.", "tengo", "tener", "tienes", "tenemos")

        elif random_question == 2:
            four_answers_mode(
                "Ser con nosotros.", "soy", "ser", "eres", "somos")

        elif random_question == 3:
            four_answers_mode(
                "Ir con nosotros.", "voy", "ir", "vas", "vamos")

        elif random_question == 4:
            four_answers_mode(
                "Tener con nosotras.", "tengo", "tener", "tienes", "tenemos")

        elif random_question == 5:
            four_answers_mode(
                "Ser con nosotras.", "soy", "ser", "eres", "somos")

        else:
            four_answers_mode(
                "Ir con nosotras.", "voy", "ir", "vas", "vamos")
        ...
        if random_question == 1:
            four_answers_mode(
                "Tener con vosotros.", "tengo", "tener", "tienes", "teneis")

        elif random_question == 2:
            four_answers_mode(
                "Ser con vosotros.", "soy", "ser", "eres", "sois")

        elif random_question == 3:
            four_answers_mode(
                "Ir con vosotros.", "voy", "ir", "vas", "vais")

        elif random_question == 1:
            four_answers_mode(
                "Tener con vosotras.", "tengo", "tener", "tienes", "teneis")

        elif random_question == 2:
            four_answers_mode(
                "Ser con vosotras.", "soy", "ser", "eres", "sois")

        else:
            four_answers_mode(
                "Ir con vosotras.", "voy", "ir", "vas", "vais")
        ...
        if random_question == 1:
            four_answers_mode(
                "Tener con ellos.", "tengo", "tener", "tienes", "tienen")

        elif random_question == 2:
            four_answers_mode(
                "Ser con ellos.", "soy", "ser", "eres", "son")

        elif random_question == 3:
            four_answers_mode(
                "Ir con ellos.", "voy", "ir", "vas", "van")

        elif random_question == 4:
            four_answers_mode(
                "Tener con ellas.", "tengo", "tener", "tienes", "tienen")

        elif random_question == 5:
            four_answers_mode(
                "Ser con ellas.", "soy", "ser", "eres", "son")

        elif random_question == 6:
            four_answers_mode(
                "Ir con ellas.", "voy", "ir", "vas", "van")

        elif random_question == 7:
            four_answers_mode(
                "Tener con Carla y Juan.", "tengo", "tener",
                "tienes", "tienen")

        elif random_question == 8:
            four_answers_mode(
                "Ser con Carla y Juan.", "soy", "ser", "eres", "son")

        elif random_question == 9:
            four_answers_mode(
                "Ir con Carla y Juan.", "voy", "ir", "vas", "van")

        elif random_question == 10:
            four_answers_mode(
                "Tener con ustedes.", "tengo", "tener", "tienes", "tienen")

        elif random_question == 11:
            four_answers_mode(
                "Ser con ustedes.", "soy", "ser", "eres", "son")

        elif random_question == 12:
            four_answers_mode(
                "Ir con ustedes.", "voy", "ir", "vas", "van")
...
def exercice3():
    ...
    if random_question == 1:
        ...
        if random_question == 1:
            four_answers_mode(
                "Dormirse con yo.", "te duermes", "se duerme",
                "nos dormemos", "me duermo")

        elif random_question == 2:
            four_answers_mode(
                "Llamarse con yo.", "te llamas", "se llama",
                "nos llamamos", "me llamo")

        elif random_question == 3:
            four_answers_mode(
                "Levantarse con yo.", "te levantas", "se levanta",
                "nos levantamos", "me levantamo")
        ...
        if random_question == 1:
            four_answers_mode(
                "Dormirse con tú.", "se duerme", "nos dormemos",
                "me duermo", "te duermes")

        elif random_question == 2:
            four_answers_mode(
                "Llamarse con tú.", "se llama", "nos llamamos",
                "me llamo", "te llamas")

        elif random_question == 3:
            four_answers_mode(
                "Levantarse con tú.", "se levanta", "nos levantamos",
                "me levantamo", "te levantas")
        ...
        if random_question == 1:
            four_answers_mode(
                "Dormirse con él.", "te duermes", "nos dormemos",
                "me duermo", "se duerme")

        elif random_question == 2:
            four_answers_mode(
                "Llamarse con él.", "te llamas", "nos llamamos",
                "me llamo", "se llama")

        elif random_question == 3:
            four_answers_mode(
                "Levantarse con él.", "te levantas", "nos levantamos",
                "me levantamo", "se levanta")

        elif random_question == 4:
            four_answers_mode(
                "Dormirse con ella.", "te duermes", "nos dormemos",
                "me duermo", "se duerme")

        elif random_question == 5:
            four_answers_mode(
                "Llamarse con ella.", "te llamas", "nos llamamos",
                "me llamo", "se llama")

        elif random_question == 6:
            four_answers_mode(
                "Levantarse con ella.", "te levantas", "nos levantamos",
                "me levantamo", "se levanta")

        elif random_question == 7:
            four_answers_mode(
                "Dormirse con Juan.", "te duermes", "nos dormemos",
                "me duermo", "se duerme")

        elif random_question == 8:
            four_answers_mode(
                "Llamarse con Juan.", "te llamas", "nos llamamos",
                "me llamo", "se llama")

        elif random_question == 9:
            four_answers_mode(
                "Levantarse con Juan.", "te levantas", "nos levantamos",
                "me levantamo", "se levanta")

        elif random_question == 10:
            four_answers_mode(
                "Dormirse con Carla.", "te duermes", "nos dormemos",
                "me duermo", "se duerme")

        elif random_question == 11:
            four_answers_mode(
                "Llamarse con Carla.", "te llamas", "nos llamamos",
                "me llamo", "se llama")

        elif random_question == 12:
            four_answers_mode(
                "Levantarse con Carla.", "te levantas", "nos levantamos",
                "me levantamo", "se levanta")

        elif random_question == 13:
            four_answers_mode(
                "Dormirse con usted.", "te duermes", "nos dormemos",
                "me duermo", "se duerme")

        elif random_question == 14:
            four_answers_mode(
                "Llamarse con usted.", "te llamas", "nos llamamos",
                "me llamo", "se llama")

        elif random_question == 15:
            four_answers_mode(
                "Levantarse con usted.", "te levantas", "nos levantamos",
                "me levantamo", "se levanta")
        ...
        if random_question == 1:
            four_answers_mode(
                "Dormirse con nosotros.", "te duermes", "se duerme",
                "me duermo", "nos dormemos")

        elif random_question == 2:
            four_answers_mode(
                "Llamarse con nosotros.", "te llamas", "se llama",
                "me llamo", "nos llamamos")

        elif random_question == 3:
            four_answers_mode(
                "Levantarse con nosotros.", "te levantas", "se levanta",
                "me levantamo", "nos levantamos")

        elif random_question == 4:
            four_answers_mode(
                "Dormirse con nosotras.", "te duermes", "se duerme",
                "me duermo", "nos dormemos")

        elif random_question == 5:
            four_answers_mode(
                "Llamarse con nosotras.", "te llamas", "se llama",
                "me llamo", "nos llamamos")

        else:
            four_answers_mode(
                "Levantarse con nosotras.", "te levantas", "se levanta",
                "me levantamo", "nos levantamos")
        ...
        if random_question == 1:
            four_answers_mode(
                "Dormirse con vosotros.", "te duermes", "se duerme",
                "nos dormemos", "os dormís")

        elif random_question == 2:
            four_answers_mode(
                "Llamarse con vosotros.", "te llamas", "se llama",
                "nos llamamos", "os llamáis")

        elif random_question == 3:
            four_answers_mode(
                "Levantarse con vosotros.", "te levantas", "se levanta",
                "nos levantamos", "os levantáis")

        elif random_question == 1:
            four_answers_mode(
                "Dormirse con vosotras.", "te duermes", "se duerme",
                "nos dormemos", "os dormís")

        elif random_question == 2:
            four_answers_mode(
                "Llamarse con vosotras.", "te llamas", "se llama",
                "nos llamamos", "os llamáis")

        else:
            four_answers_mode(
                "Levantarse con vosotras.", "te levantas", "se levanta",
                "nos levantamos", "os levantáis")
        ...
        if random_question == 1:
            four_answers_mode(
                "Dormirse con ellos.", "te duermes", "se duerme",
                "nos dormemos", "se duermen")

        elif random_question == 2:
            four_answers_mode(
                "Llamarse con ellos.", "te llamas", "se llama",
                "nos llamamos", "se llaman")

        elif random_question == 3:
            four_answers_mode(
                "Levantarse con ellos.", "te levantas", "se levanta",
                "nos levantamos", "se levantaman")

        elif random_question == 4:
            four_answers_mode(
                "Dormirse con ellas.", "te duermes", "se duerme",
                "nos dormemos", "se duermen")

        elif random_question == 5:
            four_answers_mode(
                "Llamarse con ellas.", "te llamas", "se llama",
                "nos llamamos", "se llaman")

        elif random_question == 6:
            four_answers_mode(
                "Levantarse con ellas.", "te levantas", "se levanta",
                "nos levantamos", "se levantaman")

        elif random_question == 7:
            four_answers_mode(
                "Dormirse con Carla y Juan.", "te duermes", "se duerme",
                "nos dormemos", "se duermen")

        elif random_question == 8:
            four_answers_mode(
                "Llamarse con Carla y Juan.", "te llamas", "se llama",
                "nos llamamos", "se llaman")

        elif random_question == 9:
            four_answers_mode(
                "Levantarse con Carla y Juan.", "te levantas", "se levanta",
                "nos levantamos", "se levantaman")

        elif random_question == 10:
            four_answers_mode(
                "Dormirse con ustedes.", "te duermes", "se duerme",
                "nos dormemos", "se duermen")

        elif random_question == 11:
            four_answers_mode(
                "Llamarse con ustedes.", "te llamas", "se llama",
                "nos llamamos", "se llaman")

        elif random_question == 12:
            four_answers_mode(
                "Levantarse con ustedes.", "te levantas", "se levanta",
                "nos levantamos", "se levantaman")
...
def exercice4():
    ...
    if random_question == 1:
        ...
        if random_question == 1:
            four_answers_mode(
                "Poder con yo.", "podo", "puedes", "podoy", "puedo")

        elif random_question == 2:
            four_answers_mode(
                "Pensar con yo.", "penso", "piensas", "pensoy", "pienso")

        elif random_question == 3:
            four_answers_mode(
                "Jugar con yo.", "jugo", "juegas", "jugoy", "juego")
        ...
        if random_question == 1:
            four_answers_mode(
                "Poder con tú.", "podes", "podoy", "puedo", "puedes")

        elif random_question == 2:
            four_answers_mode(
                "Pensar con tú.", "pensas", "pensoy", "pienso", "piensas")

        elif random_question == 3:
            four_answers_mode(
                "Jugar con tú.", "jugas", "jugoy", "juego", "juegas")
        ...
        if random_question == 1:
            four_answers_mode(
                "Poder con él.", "podo", "podoy", "puedo", "puede")

        elif random_question == 2:
            four_answers_mode(
                "Pensar con él.", "penso", "pensoy", "pienso", "piensa")

        elif random_question == 3:
            four_answers_mode(
                "Jugar con él.", "jugo", "jugoy", "juego", "juega")

        elif random_question == 4:
            four_answers_mode(
                "Poder con ella.", "podo", "podoy", "puedo", "puede")

        elif random_question == 5:
            four_answers_mode(
                "Pensar con ella.", "penso", "pensoy", "pienso", "piensa")

        elif random_question == 6:
            four_answers_mode(
                "Jugar con ella.", "jugo", "jugoy", "juego", "juega")

        elif random_question == 7:
            four_answers_mode(
                "Poder con usted.", "podo", "podoy", "puedo", "puede")

        elif random_question == 8:
            four_answers_mode(
                "Pensar con usted.", "penso", "pensoy", "pienso", "piensa")

        elif random_question == 9:
            four_answers_mode(
                "Jugar con usted.", "jugo", "jugoy", "juego", "juega")

        elif random_question == 10:
            four_answers_mode(
                "Poder con Carla.", "podo", "podoy", "puedo", "puede")

        elif random_question == 11:
            four_answers_mode(
                "Pensar con Carla.", "penso", "pensoy", "pienso", "piensa")

        elif random_question == 12:
            four_answers_mode(
                "Jugar con Carla.", "jugo", "jugoy", "juego", "juega")

        elif random_question == 13:
            four_answers_mode(
                "Poder con Juan.", "podo", "podoy", "puedo", "puede")

        elif random_question == 14:
            four_answers_mode(
                "Pensar con Juan.", "penso", "pensoy", "pienso", "piensa")

        elif random_question == 15:
            four_answers_mode(
                "Jugar con Juan.", "jugo", "jugoy", "juego", "juega")
        ...
        if random_question == 1:
            four_answers_mode(
                "Poder con nosotros.", "puedemos", "puedéis",
                "podéis", "podemos")

        elif random_question == 2:
            four_answers_mode(
                "Pensar con nosotros.", "piensamos", "piensáis",
                "pensáis", "pensamos")

        elif random_question == 3:
            four_answers_mode(
                "Jugar con nosotros.", "juegamos", "juegáis",
                "jugáis", "jugamos")

        elif random_question == 4:
            four_answers_mode(
                "Poder con nosotras.", "puedemos", "puedéis",
                "podéis", "podemos")

        elif random_question == 5:
            four_answers_mode(
                "Pensar con nosotras.", "piensamos", "piensáis",
                "pensáis", "pensamos")

        else:
            four_answers_mode(
                "Jugar con nosotras.", "juegamos", "juegáis",
                "jugáis", "jugamos")
        ...
        if random_question == 1:
            four_answers_mode(
                "Poder con vosotros.", "puedemos", "puedéis",
                "podemos", "podéis")

        elif random_question == 2:
            four_answers_mode(
                "Pensar con vosotros.", "piensamos", "piensáis",
                "pensamos", "pensáis")

        elif random_question == 3:
            four_answers_mode(
                "Jugar con vosotros.", "juegamos", "juegáis",
                "jugamos", "jugáis")

        elif random_question == 1:
            four_answers_mode(
                "Poder con vosotras.", "puedemos", "puedéis",
                "podemos", "podéis")

        elif random_question == 2:
            four_answers_mode(
                "Pensar con vosotras.", "piensamos", "piensáis",
                "pensamos", "pensáis")

        else:
            four_answers_mode(
                "Jugar con vosotras.", "juegamos", "juegáis",
                "jugamos", "jugáis")
        ...
        if random_question == 1:
            four_answers_mode(
                "Poder con ellos.", "puedemos", "podemos", "poden", "pueden")

        elif random_question == 2:
            four_answers_mode(
                "Pensar con ellos.", "piensamos", "pensamos",
                "pensan", "piensan")

        elif random_question == 3:
            four_answers_mode(
                "Jugar con ellos.", "juegamos", "jugamos", "jugan", "juegan")

        elif random_question == 4:
            four_answers_mode(
                "Poder con ellas.", "puedemos", "podemos", "poden", "pueden")

        elif random_question == 5:
            four_answers_mode(
                "Pensar con ellas.", "piensamos", "pensamos",
                "pensan", "piensan")

        elif random_question == 6:
            four_answers_mode(
                "Jugar con ellas.", "juegamos", "jugamos", "jugan", "juegan")

        elif random_question == 7:
            four_answers_mode(
                "Poder con ustedes.", "puedemos", "podemos", "poden", "pueden")

        elif random_question == 8:
            four_answers_mode(
                "Pensar con ustedes.", "piensamos", "pensamos",
                "pensan", "piensan")

        elif random_question == 9:
            four_answers_mode(
                "Jugar con ustedes.", "juegamos", "jugamos", "jugan", "juegan")

        elif random_question == 10:
            four_answers_mode(
                "Poder con Carla y Juan.", "puedemos", "podemos",
                "poden", "pueden")

        elif random_question == 11:
            four_answers_mode(
                "Pensar con Carla y Juan.", "piensamos", "pensamos",
                "pensan", "piensan")

        elif random_question == 12:
            four_answers_mode(
                "Jugar con Carla y Juan.", "juegamos", "jugamos",
                "jugan", "juegan")
...
def exercice5():
    ...
    if random_question == 1:
        ...
        if random_question == 1:
            four_answers_mode(
                "Medir con yo.", "medo", "mides", "medes", "mido")

        elif random_question == 2:
            four_answers_mode(
                "Vestir con yo.", "vesto", "vistes", "vestes", "visto")

        elif random_question == 3:
            four_answers_mode(
                "Pedir con yo.", "pedo", "pides", "pedes", "pido")
        ...
        if random_question == 1:
            four_answers_mode(
                "Medir con tú.", "medo", "medes", "mido", "mides")

        elif random_question == 2:
            four_answers_mode(
                "Vestir con tú.", "vesto", "vestes", "visto", "vistes")

        elif random_question == 3:
            four_answers_mode(
                "Pedir con tú.", "pedo", "pedes", "pido", "pides")
        ...
        if random_question == 1:
            four_answers_mode(
                "Medir con él.", "medo", "mido", "mede", "mide")

        elif random_question == 2:
            four_answers_mode(
                "Vestir con él.", "vesto", "visto", "veste", "viste")

        elif random_question == 3:
            four_answers_mode(
                "Pedir con él.", "pedo", "pido", "pede", "pide")

        elif random_question == 4:
            four_answers_mode(
                "Medir con ella.", "medo", "mido", "mede", "mide")

        elif random_question == 5:
            four_answers_mode(
                "Vestir con ella.", "vesto", "visto", "veste", "viste")

        elif random_question == 6:
            four_answers_mode(
                "Pedir con ella.", "pedo", "pido", "pede", "pide")

        elif random_question == 7:
            four_answers_mode(
                "Medir con Carla.", "medo", "mido", "mede", "mide")

        elif random_question == 8:
            four_answers_mode(
                "Vestir con Carla.", "vesto", "visto", "veste", "viste")

        elif random_question == 9:
            four_answers_mode(
                "Pedir con Carla.", "pedo", "pido", "pede", "pide")

        elif random_question == 10:
            four_answers_mode(
                "Medir con Juan.", "medo", "mido", "mede", "mide")

        elif random_question == 11:
            four_answers_mode(
                "Vestir con Juan.", "vesto", "visto", "veste", "viste")

        elif random_question == 12:
            four_answers_mode(
                "Pedir con Juan.", "pedo", "pido", "pede", "pide")

        elif random_question == 13:
            four_answers_mode(
                "Medir con usted.", "medo", "mido", "mede", "mide")

        elif random_question == 14:
            four_answers_mode(
                "Vestir con usted.", "vesto", "visto", "veste", "viste")

        elif random_question == 15:
            four_answers_mode(
                "Pedir con usted.", "pedo", "pido", "pede", "pide")
        ...
        if random_question == 1:
            four_answers_mode(
                "Medir con nosotros.", "medís", "midemos", "midéis", "medimos")

        elif random_question == 2:
            four_answers_mode(
                "Vestir con nosotros.", "vestís", "vistemos",
                "vistéis", "vestimos")

        elif random_question == 3:
            four_answers_mode(
                "Pedir con nosotros.", "pedís", "pidemos", "pidéis", "pedimos")

        elif random_question == 4:
            four_answers_mode(
                "Medir con nosotras.", "medís", "midemos", "midéis", "medimos")

        elif random_question == 5:
            four_answers_mode(
                "Vestir con nosotras.", "vestís", "vistemos",
                "vistéis", "vestimos")

        else:
            four_answers_mode(
                "Pedir con nosotras.", "pedís", "pidemos", "pidéis", "pedimos")
        ...
        if random_question == 1:
            four_answers_mode(
                "Medir con vosotros.", "midemos", "midéis", "medimos", "medís")

        elif random_question == 2:
            four_answers_mode(
                "Vestir con vosotros.", "vistemos", "vistéis",
                "vestimos", "vestís")

        elif random_question == 3:
            four_answers_mode(
                "Pedir con vosotros.", "pidemos", "pidéis", "pedimos", "pedís")

        elif random_question == 1:
            four_answers_mode(
                "Medir con vosotras.", "midemos", "midéis", "medimos", "medís")

        elif random_question == 2:
            four_answers_mode(
                "Vestir con vosotras.", "vistemos", "vistéis",
                "vestimos", "vestís")

        else:
            four_answers_mode(
                "Pedir con vosotras.", "pidemos", "pidéis", "pedimos", "pedís")
        ...
        if random_question == 1:
            four_answers_mode(
                "Medir con ellos.", "midemos", "medimos", "medin", "miden")

        elif random_question == 2:
            four_answers_mode(
                "Vestir con ellos.", "vistemos", "vestimos",
                "vestin", "visten")

        elif random_question == 3:
            four_answers_mode(
                "Pedir con ellos.", "pidemos", "pedimos", "pedin", "piden")

        elif random_question == 4:
            four_answers_mode(
                "Medir con ellas.", "midemos", "medimos", "medin", "miden")

        elif random_question == 5:
            four_answers_mode(
                "Vestir con ellas.", "vistemos", "vestimos",
                "vestin", "visten")

        elif random_question == 6:
            four_answers_mode(
                "Pedir con ellas.", "pidemos", "pedimos", "pedin", "piden")

        elif random_question == 7:
            four_answers_mode(
                "Medir con Carla y Juan.", "midemos", "medimos",
                "medin", "miden")

        elif random_question == 8:
            four_answers_mode(
                "Vestir con Carla y Juan.", "vistemos", "vestimos",
                "vestin", "visten")

        elif random_question == 9:
            four_answers_mode(
                "Pedir con Carla y Juan.", "pidemos", "pedimos",
                "pedin", "piden")

        elif random_question == 10:
            four_answers_mode(
                "Medir con ustedes.", "midemos", "medimos",
                "medin", "miden")

        elif random_question == 11:
            four_answers_mode(
                "Vestir con ustedes.", "vistemos", "vestimos",
                "vestin", "visten")

        elif random_question == 12:
            four_answers_mode(
                "Pedir con ustedes.", "pidemos", "pedimos",
                "pedin", "piden")
...
def exercice6():
    ...
    if random_question == 1:
        ...
        if random_question == 1:
            four_answers_mode(
                "Vivir con él en imperatovo.", "vivo", "vivi",
                "vivimos", "vive")

        elif random_question == 2:
            four_answers_mode(
                "Hablar con él en imperatovo.", "hablo", "hablar",
                "hablamos", "habla")

        elif random_question == 3:
            four_answers_mode(
                "Comer con él en imperatovo.", "como", "comer",
                "comemos", "come")

        elif random_question == 4:
            four_answers_mode(
                "Vivir con ella en imperatovo.", "vivo", "vivi",
                "vivimos", "vive")

        elif random_question == 5:
            four_answers_mode(
                "Hablar con ella en imperatovo.", "hablo", "hablar",
                "hablamos", "habla")

        elif random_question == 6:
            four_answers_mode(
                "Comer con ella en imperatovo.", "como", "comer",
                "comemos", "come")

        elif random_question == 7:
            four_answers_mode(
                "Vivir con Juan en imperatovo.", "vivo", "vivi",
                "vivimos", "vive")

        elif random_question == 8:
            four_answers_mode(
                "Hablar con Juan en imperatovo.", "hablo", "hablar",
                "hablamos", "habla")

        elif random_question == 9:
            four_answers_mode(
                "Comer con Juan en imperatovo.", "como", "comer",
                "comemos", "come")

        elif random_question == 10:
            four_answers_mode(
                "Vivir con Carla en imperatovo.", "vivo", "vivi",
                "vivimos", "vive")

        elif random_question == 11:
            four_answers_mode(
                "Hablar con Carla en imperatovo.", "hablo", "hablar",
                "hablamos", "habla")

        elif random_question == 12:
            four_answers_mode(
                "Comer con Carla en imperatovo.", "como", "comer",
                "comemos", "come")

        elif random_question == 13:
            four_answers_mode(
                "Vivir con usted en imperatovo.", "vivo", "vivi",
                "vivimos", "vive")

        elif random_question == 14:
            four_answers_mode(
                "Hablar con usted en imperatovo.", "hablo", "hablar",
                "hablamos", "habla")

        elif random_question == 15:
            four_answers_mode(
                "Comer con usted en imperatovo.", "como", "comer",
                "comemos", "come")
        ...
        if random_question == 1:
            four_answers_mode(
                "Vivir con vosotros en imperatovo.", "vivo", "vivir",
                "vivís", "vivid")

        elif random_question == 2:
            four_answers_mode(
                "Hablar con vosotros en imperatovo.", "hablo", "hablar",
                "habláis", "hablad")

        elif random_question == 3:
            four_answers_mode(
                "Comer con vosotros en imperatovo.", "como", "comer",
                "coméis", "comed")

        elif random_question == 1:
            four_answers_mode(
                "Vivir con vosotras en imperatovo.", "vivo", "vivir",
                "vivís", "vivid")

        elif random_question == 2:
            four_answers_mode(
                "Hablar con vosotras en imperatovo.", "hablo", "hablar",
                "habláis", "hablad")

        else:
            four_answers_mode(
                "Comer con vosotras en imperatovo.", "como", "comer",
                "coméis", "comed")
...
bottom_comments_layout.addWidget(
    bottom_comments_label, alignment=Qt.AlignCenter)
